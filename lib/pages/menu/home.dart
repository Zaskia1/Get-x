...
import 'package:flutter_android/components/common/Style.dart';
...
class _MyHomePageState extends State<Home> {
            ...
            child: Column(
              ...
              children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Icon(Icons.star, color: Colors.white, size: 17),
                                Icon(Icons.star, color: Colors.white, size: 17),
                                Text(" 250 Ratings", style: TextStyle(color: Colors.white, fontSize: 10)),
                              ],
                            ),
                            SizedBox(height: 10,),
                            Text("Lorem ipsum is a dummy text used for printing", style: TextStyle(color: Colors.white, fontSize: 13)),
                          ],
                        ),
                      ),
                      SizedBox(width: 10,),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 15,),
                                Text("Yoshimasa Sushi", style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700)),
                                SizedBox(height: 5,),
                                Row(
                                  children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 15,),
                                Text("Prato Sushi", style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700)),
                                SizedBox(height: 5,),
                                Row(
                                  children: [
                                    Icon(Icons.star, color: Colors.white, size: 14),
                ...
                Row(
                  ...
                  children: [
                    Text("Places", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700)),
                    SizedBox(width: 10,),
                    Expanded(
                      child: Container(
  ...
  Row placesWidget(String img, String name) {
    ...
    Text("Lorem ipsum sits dolar amet is for publishing", style: TextStyle(fontSize: 12)),
    ],
    ),
    ),
    InkWell(
