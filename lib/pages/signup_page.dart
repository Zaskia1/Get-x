...
class _SignupPageState extends State<SignupPage> {
                      ...
                      SizedBox(
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () => Get.to(() => const LoginPage()), // Navigasi menggunakan GetX
                              child: const Text(
                                'Log-in',
  ...
  void _handleSignupUser() {
    ...
    if (_signupFormKey.currentState!.validate()) {
      // Tampilkan snackbar
      Get.snackbar('Sign-up Success', 'You have registered successfully!',
          snackPosition: SnackPosition.BOTTOM);

      // Pindah ke halaman home setelah signup sukses
